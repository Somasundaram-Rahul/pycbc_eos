...
def tov_solve(epsilon,press,c2_s):
    ...
    spl3 = interpolate.splrep(enthalpy, c2_s,k=3) 
    ...
    central_enthalpies = np.geomspace(0.1,1.4,50)
    ...
    for i,h_c in enumerate(central_enthalpies):
        ...
        sol1 = solve_ivp(tovrhs, (h_c, 1.e-10), initial, args=(eos1,eos2,eos3),method='LSODA')
